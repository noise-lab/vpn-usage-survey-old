\subsection{\mbox{What Students Know \& Expect From VPNs}}\label{part1_findings}

\subsubsection{Students Know VPNs Mask Internet Activity}

The majority of interviewees and survey respondents were able to define that a VPN  changes what others can see about your Internet activity. For instance, almost half (14/32) interviewees defined a VPN as an
...
computer. So it figures that they downloaded it and not you.( P18)\end{quote}
 ...
 \mc{Andre, what did the rest of them think?} \ax{graph here?} Just under half, 42\% (147/350) of survey
respondents mentioned that VPNs are tools that mask the user’s location in open-ended responses. Only
4\% (14/350) of respondents indicated that they did not know what VPNs were in open-ended responses.

The details of how the VPN worked however were less clear to interviewees and survey respondents. Some interviewees believed that VPNs allow you to access blocked content (13/32), allow access into another network (7/32) and others described a VPN as secure,  private, or adding an extra level of safety (13/32). In a similar vein, three quarters of survey respondents indicated that they thought their VPNs guaranteed access to certain content
 (75\%, 263/350) and masking of their Internet Protocol addresses (53\%, 186/350). In a quote typical of what we heard in interviewees, P25 described a VPN as:
\begin{quote} Its usefulness is pragmatism, it's like, "I need to see this YouTube video, but they don't let me see it in Brazil so I'm just going to do it
 ...
 Most interviewees and survey respondents felt they were not experts in VPNs. For instance, a good proportion of interviewees (12/32) admitted that they did not have an extensive knowledge
about VPNs. For instance, a few interviewees defined VPN as a black box and described people who are
interested in VPN as technology-savvy (4/32). For instance, P27 shared \textit{"you have to be a super nerd"} to understand what VPNs are and do. Survey respondents also did not claim to know alot about VPNs. 76\% (266/350) of survey respondents reported having some knowledge of
VPNs, and 19\% (68/350) reported having no knowledge. In contrast, only 4\%
(16/350) of survey respondents considered themselves to have high knowledge or to be experts on
VPNs. Overall, our participants had a good idea about what VPN is but most did not understand how VPN works or have a good knowledge base about VPNs in general.

\subsubsection{Students Do Not Expect Total Anonymity} 
Our participants generally did not feel that VPNs provided total anonymity. For instance, three quarters of interviewees (24/32) told us that you can be tracked
while using VPNs and some believed that there is always a way to do so
(8/32) and that you can be tracked by VPN provider itself (9/32). Similarly, only around one third of survey respondents believed that their VPNs guaranteed privacy (36\%,
125/350), anonymity (30\%, 104/350), and safety from tracking (28\%, 99/350). In a quote that illustrates the sentiment, P01 explained:

\begin{quote}If it is SSL encryption, the VPN provider would still know
...
not encrypted, then they can see. They can be doing packet sniffing or even more
...
More interviewees did not
believe that VPN guaranteed them anonymity (20/32) than those who felt the VPN did offer privacy and anonymity (8/32). Some were convinced that the government could track you even while using a VPN. For example, P30 used a VPN only in different countries to access
blocked content. They did not continue to use a VPN in the USA as they did not need VPN's to access
content anymore and did not see any privacy protecting reasons because all VPNs are \textit{"partially, controlled
or transparent to the government"}. Other interviewees explained one can still be tracked by
 advertising agencies even if the VPN makes
 tracking at least harder than normal.To overcome tracking issues, P21 explained that using VPN is not enough and instead they changed locations frequently when they connected within VPN:
...
\paragraph{Students Learn How VPNs Work By Searching Online}
...
the same channels where they first heard about VPNs. \ax{corr}
...
choosing a VPN, and were generally less concerned about protecting security. \ax{corr}
...
factors, and also used VPN more often and in more places. \ax{corr}
...
\paragraph{Free VPNs Feel Less Secure} We asked respondents to indicate how safe they felt when using free, paid, and
...
\begin{quote}When Netflix wasn't available in Germany, people would try to use [it]. It is [available] now, but in the beginning, things like Netflix were
