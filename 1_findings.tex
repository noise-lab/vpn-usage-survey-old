...
contents; some responses contained multiple topics. \mc{Andre, what did the rest of them think?} \ax{graph here?} 42\% (147/350) of
...
interviewees found it simple to use for the first time. \ax{I think this is related to the previous section; my relevant data is there}
...
\textbf{VPN is not used for Privacy} Only 36\% (127/350) of survey respondents reported using VPN for privacy. 13 interviewees said that privacy was not
...
Internet connection is slower while using VPN. \ax{no data from survey}
...
were more likely to have stopped using VPN. \ax{corr}
